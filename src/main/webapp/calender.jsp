...
<body>
	...
	<div class="container">
		...
		<aside class="sidebar">
			...
			<form id="controls" method="POST"
				action="CalenderController?action=addEvent">
				<label for="eventTitle">일정 제목:</label> <input type="text"
					id="eventTitle" name="sche_title" placeholder="일정 입력" required>
				<label for="startDate">시작 날짜:</label> <input type="date"
					id="startDate" name="sche_st_dt" required> <label
	...
	<div id="modal" style="display: none;">
		<form id="editEventForm" method="POST"
			action="CalenderUpdateController">
			<input type="hidden" name="sche_idx" id="modal-sche-idx"> <label
				for="modal-sche-title">일정 제목:</label> <input type="text"
				name="sche_title" id="modal-sche-title" required> <br>
			<label for="modal-sche-st-dt">시작 날짜:</label> <input type="date"
				name="sche_st_dt" id="modal-sche-st-dt" required><br> <label
				for="modal-sche-ed-dt">종료 날짜:</label> <input type="date"
				name="sche_ed_dt" id="modal-sche-ed-dt" required>
